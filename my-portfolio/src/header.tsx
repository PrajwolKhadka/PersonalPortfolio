...
const Navbar: React.FC= () => { 
    ...
    <ul className=" flex space-x-8 items-center"> 
        ...
        <li> 
            <a href="/project" className="text-white uppercase tracking-widest"  style={{ fontFamily: "'Doto', sans-serif" }}> Projects </a> </li> 
        <li> 
        ...
        <li> 
            <Link to="/blogs" className="text-white uppercase tracking-widest"  style={{ fontFamily: "'Doto', sans-serif" }}> Blogs </Link> </li>   
        </ul>
