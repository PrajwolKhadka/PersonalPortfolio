...
//   const prevModal = () => setModalIndex((prev) => (prev !== null ? (prev === 0 ? certificates.length - 1 : prev - 1) : null));
//   const nextModal = () => setModalIndex((prev) => (prev !== null ? (prev === certificates.length - 1 ? 0 : prev + 1) : null));
...
//         <h1 className="text-white font-bold text-4xl mb-2" style={{ fontFamily: 'Poltawski Nowy, serif' }}>Proof of Learning</h1>
//         <p className="text-white" style={{ fontFamily: 'Merriweather, serif' }}>Every certificate tells a story of dedication and growth.</p>
//       </div>
...
//         <button
//           onClick={() => scroll("left")}
//           className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-3 bg-gray-800 text-white rounded-full hover:bg-gray-700"
//         >
//           <FaChevronLeft />
//         </button>
//         <button
//           onClick={() => scroll("right")}
//           className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-3 bg-gray-800 text-white rounded-full hover:bg-gray-700"
//         >
//           <FaChevronRight />
//         </button>
...
//             <div
//               key={idx}
//               className="min-w-[250px] flex-shrink-0 bg-gray-900 text-white rounded-xl p-4 flex flex-col items-center snap-start"
//             >
//               <img
//                 src={cert.image}
//                 alt={cert.name}
...
//               />
//               <h3 className="text-lg font-semibold text-center break-words text-ellipsis max-w-[220px]" style={{fontFamily: 'Merriweather, serif'}}>{cert.name}</h3>
//               <p className="text-sm text-gray-400" style={{ fontFamily: "'Doto', sans-serif" }}>{cert.institute}</p>
//               {cert.link && (
//                 <a
//                   href={cert.link}
//                   target="_blank"
